        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <div className="bg-primary/5 border border-primary/20 rounded-lg p-4 mb-4">
              <p className="text-sm leading-relaxed"><strong>Transparency Notice:</strong> The App uses AI models to generate meal suggestions and food images. Here's exactly how your data is handled:</p>
            </div>
            <ul className="list-disc pl-6 space-y-2 text-sm">
              <li><strong>What is sent:</strong> Your child's age, food history, known allergies, dietary preferences, and feeding approach are included in AI prompts to generate relevant suggestions</li>
              <li><strong>Processing:</strong> Data is sent to AI model providers on a per-request basis only when you actively request meal suggestions or food images</li>
              <li><strong>No storage by AI providers:</strong> Your child's data is processed in real-time and is not retained, stored, or used for training by AI model providers after the request is completed</li>
              ...
              <li><strong>Opt-out:</strong> AI features are entirely optional. You can use the App without ever requesting AI suggestions</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-sm">
              ...
              <li><strong>AI processing:</strong> Child data sent to AI providers for meal suggestions (see Section 5)</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-sm">
              ...
              <li><strong>Preference storage:</strong> Your consent choices, theme preferences, and onboarding state</li>
          ...
          <section>
            ...
            <p className="leading-relaxed">We retain your data for as long as your account is active. When you delete your account, all personal data — including child profiles, diary entries, photos, allergen records, meal plans, and all tracking data — is permanently removed within 30 days. Anonymized, aggregated usage statistics may be retained for service improvement.</p>
          </section>

          {/* 12. Contact */}
          <section>
            <h2 className="text-2xl font-semibold mb-4">12. Contact Us</h2>
            <p className="leading-relaxed">If you have questions about this Privacy Policy, want to exercise your data rights, or need to report a privacy concern, please contact us through the App's support feature.</p>
          </section>
        </div>
